...
class OpenWrapMRECVideoScreen extends StatefulWidget {
  const OpenWrapMRECVideoScreen({Key? key}) : super(key: key);

  @override
  State<OpenWrapMRECVideoScreen> createState() => _OpenWrapMRECVideoScreen();
}

class _OpenWrapMRECVideoScreen extends State<OpenWrapMRECVideoScreen> {
