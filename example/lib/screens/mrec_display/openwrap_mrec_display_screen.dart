...
class OpenWrapMRECDisplayScreen extends StatefulWidget {
  const OpenWrapMRECDisplayScreen({Key? key}) : super(key: key);

  @override
  State<OpenWrapMRECDisplayScreen> createState() =>
      _OpenWrapMRECDisplayScreen();
}

class _OpenWrapMRECDisplayScreen extends State<OpenWrapMRECDisplayScreen> {
  ...
  void initState() {
    ...
    _bannerAd = POBBannerAd(
        ...
        adSizes: [POBAdSize.bannerSize300x250]);
